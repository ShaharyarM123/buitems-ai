...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen font-sans bg-white text-zinc-900 flex items-center justify-center relative overflow-hidden p-4 sm:p-6 lg:p-8 selection:bg-emerald-500 selection:text-white">
      ...
      {/* 🚀 FULLSCREEN LOADING OVERLAY HERE */}
      {loading && <LoadingScreen message="Verifying credentials & loading dashboard..." />}
      ...
      <div className="relative w-full max-w-5xl bg-zinc-50 border border-zinc-200 rounded-3xl shadow-2xl backdrop-blur-2xl overflow-hidden grid grid-cols-1 lg:grid-cols-12 animate-fade-in">
        ...
        <div className="lg:col-span-6 p-8 sm:p-12 hidden lg:flex flex-col justify-between relative overflow-hidden bg-gradient-to-br from-emerald-50/60 via-white to-zinc-50 border-r border-zinc-200">
          ...
          <div className="relative z-10">
            ...
            <p className="text-sm text-zinc-600 max-w-sm leading-relaxed">
              Access your intelligent study notes platform, powered by advanced context-aware AI agents tailored for your coursework.
            </p>
          </div>
          ...
          <div className="relative z-10 pt-8 border-t border-zinc-200 flex items-center gap-3">
            ...
            <div>
              <div className="text-xs font-bold text-zinc-900">Secure Academic Session</div>
              <div className="text-[11px] text-zinc-500">Encrypted token authentication</div>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-6 p-8 sm:p-12 flex flex-col justify-center bg-zinc-50">
          <div className="max-w-md w-full mx-auto">
            ...
            <div className="mb-8">
              <h2 className="text-2xl sm:text-3xl font-extrabold text-zinc-900 tracking-tight mb-2">Welcome Back</h2>
              <p className="text-xs sm:text-sm text-zinc-500">Please enter your details to sign in.</p>
            </div>
            ...
            <div className="text-center mt-8 text-xs text-zinc-500">
              ...
              <Link href="/signup" className="text-emerald-600 hover:underline font-bold">
                Sign up
              </Link>
            </div>
...
//               Sign in to your <br />
//               <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 via-amber-500 to-red-500">adventure!</span>
//             </h1>
...
//             </div>
//             <div>
//               <div className="text-xs font-semibold text-zinc-200">Secure Academic Session</div>
//               <div className="text-[11px] text-zinc-400">Encrypted token authentication</div>
//             </div>
//           </div>
//         </div>
...
//               <p className="text-xs sm:text-sm text-zinc-400">Please enter your details to sign in.</p>
//             </div>
...
//       <h2 className="text-2xl font-bold mb-6 text-center">Login to BUITEMS AI</h2>
...
//         Don&apos;t have an account?{' '}
//         <Link href="/signup" className="underline text-black dark:text-white">
//           Sign up
//         </Link>
//       </p>
//     </div>
